...
- [ruff - Python linter and code formatter](https://github.com/astral-sh/ruff)
- [ty - Python type checker and language server](https://github.com/astral-sh/ty)
...
- [Neogit - A git interface for Neovim, inspired by Magit](https://github.com/NeogitOrg/neogit)
